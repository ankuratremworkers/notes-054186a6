...
# Base-path routing: this service is served at /notes_054186_backend
ENV ROOT_PATH=/notes_054186_backend
...
CMD ["uvicorn", "main:app", "--host", "0.0.0.0", "--port", "8000", "--root-path", "/notes_054186_backend"]
